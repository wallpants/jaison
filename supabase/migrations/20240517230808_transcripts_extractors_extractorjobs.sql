...
alter table "public"."transcripts" drop column "label";

alter table "public"."transcripts" add column "created_at" timestamp(0) without time zone not null;

alter table "public"."transcripts" add column "language" text not null;

alter table "public"."transcripts" add column "monologues" jsonb;

alter table "public"."transcripts" add column "name" text;

alter table "public"."transcripts" add column "object_id" text not null;

alter table "public"."transcripts" add column "revai_job_id" text;

alter table "public"."transcripts" add column "status" text not null;

alter table "public"."transcripts" add column "updated_at" timestamp(0) without time zone not null;

alter table "public"."transcripts" add column "user_id" text not null;
